...
function ServiciosArt1() {
    return (
        <article className="service-card">
            ...
            <h3>Programacion web / Web development</h3>
            <p>
                Desarrollo integral de aplicaciones webs o landing pages.<br/>
                Integral development of webs aplications and landing pages.
            </p>
        </article>
    );
}
